...
HD_PWD='/home/mlenehan/Documents/Michael/ECE/ECE4/EE496/Assignment1/OneBitFullAdder/OneBitFullAdder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oneBitFullAdder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oneBitFullAdder.tcl -notrace
