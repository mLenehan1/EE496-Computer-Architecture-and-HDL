...
HD_PWD='/home/mlenehan/Documents/Michael/ECE/ECE4/EE496/Assignment1/OneBitFullAdder/OneBitFullAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oneBitFullAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oneBitFullAdder.tcl
