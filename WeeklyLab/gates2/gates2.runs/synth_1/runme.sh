...
HD_PWD='/home/mlenehan/gates2/gates2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_gates2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_gates2.tcl
