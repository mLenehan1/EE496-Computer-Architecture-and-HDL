...
HD_PWD='/home/mlenehan/gates2/gates2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_gates2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_gates2.tcl -notrace
